                ...
                <ul class="tabs-animated-shadow tabs-animated nav nav-justified tabs-shadow-bordered p-3">
                  <li class="nav-item">
                    <a role="tab" class="nav-link active" data-toggle="tab"
                      href="https://demo.dashboardpack.com/architectui-html-pro/#tab-messages-header">
                      <span>Messages</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a role="tab" class="nav-link" data-toggle="tab"
                      href="https://demo.dashboardpack.com/architectui-html-pro/#tab-events-header">
                      <span>Events</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a role="tab" class="nav-link" data-toggle="tab"
                      href="https://demo.dashboardpack.com/architectui-html-pro/#tab-errors-header">
                        ...
                        <div class="switch has-switch switch-container-class" data-class="fixed-header">
                          <div class="switch-animate switch-on">
                            <div class="toggle btn btn-success" data-toggle="toggle" role="button"
                              style="width: 55.8333px; height: 32.5312px;"><input type="checkbox" checked=""
                                data-toggle="toggle" data-onstyle="success">
                              <div class="toggle-group"><label for="" class="btn btn-success toggle-on">On</label><label
                                  for="" class="btn btn-light toggle-off">Off</label><span
                        ...
                        <div class="switch has-switch switch-container-class" data-class="fixed-footer">
                          <div class="switch-animate switch-off">
                            <div class="toggle btn btn-light off" data-toggle="toggle" role="button"
                              style="width: 55.8333px; height: 32.5312px;"><input type="checkbox" data-toggle="toggle"
