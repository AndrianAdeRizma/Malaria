                ...
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        @forelse($testings as $index => $testing)
                            <tr>
                                <td>{{ $index+1 }}</td>
                                <td>{{ $testing->pasien->nama }}</td>
                                <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $testing->pasien->tgl_lahir)->format('d/m/Y') }}</td>
                                <td>{{ \Carbon\Carbon::parse($testing->pasien->tgl_lahir)->age }}</td>
                                <td>{{ $testing->pasien->gol_darah }}</td>
                                <td>{{ $testing->diagnosa }}</td>
